...
function Level:update(dt)
  ...
  if self.launchMarker.launched then
    if love.keyboard.wasPressed('space') and not self.playerContact then
      for k, newAlienPos in pairs ({-80, 80}) do
        ...
        alien.body:setLinearVelocity(xVel + newAlienPos, yVel)
